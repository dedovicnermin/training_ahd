...
import tech.nermindedovic.xmlmessageservice.xml.trackers.Root;
import tech.nermindedovic.xmlmessageservice.xml.trackers.TagTracker;
...
public class XMLParser {
    public static PaymentMessage parsePaymentMessage(final String msg) throws XMLStreamException {
         ...
         *       Without it, conditionals would be needed and would override the PaymentMessage on_start_tag method.
         */
        ...
        while (streamReader.hasNext()) {
            ...
            switch (event) {
                 ...
                 *      : Upon complection, data gets ties to the top tracker on the stack.
                 */
                case 4:
